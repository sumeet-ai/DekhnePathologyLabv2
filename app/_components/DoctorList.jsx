        ...
        <div className='mb-10 px-8'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-7 mt-4 lg:grid-cols-4' >
                {doctorList&&doctorList.map((doctor,index)=>(
                    <div className='border-[1px] rounded-lg p-3 cursor-pointer hover:border-primary hover:shadow-sm-black transition-all ease-in-out transform hover:scale-105 duration-300' key={index}>
                        <Image 
